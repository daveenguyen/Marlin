...
#define STRING_CONFIG_H_AUTHOR "(Davee, lucy 2016.06.21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lucy"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Lucy
  #define  DEFAULT_Kp  31.05
  #define  DEFAULT_Ki   1.97
  #define  DEFAULT_Kd 122.09
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 235.81
  #define  DEFAULT_bedKi 9.71
  #define  DEFAULT_bedKd 1431.44
#endif // PIDTEMPBED
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,76,4000,585}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 2.4, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,60,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
